...
## Current Context
- **Just shipped:** Locum tenens provider coverage page, clinic simulator mid-size FQHC preset, Strategy nav mega menu, SF crisis intel cluster (8 items)
...
- **Data:** 177 job listings, 220 FQHCs (127 from HRSA need enrichment), 20 layoff entries (3,477+ workers), 576 live API-scrapeable jobs, 49 intel items, 22 case studies, 16 AI tracker items, 12 OKR templates, 18 masterclass modules, 20 certifications, 13 guides, 200+ bibliography resources
