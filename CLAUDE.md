...
## Current Context
- **Just shipped:** Regional news scanning system (9 regions, 5-day rotation), San Diego + Inland Empire regional intel, SF crisis cluster (8 items), locum tenens page, clinic simulator, mega menu
...
- **Data:** 177 job listings, 220 FQHCs (127 from HRSA need enrichment), 20 layoff entries (3,477+ workers), 576 live API-scrapeable jobs, 55 intel items, 22 case studies, 16 AI tracker items, 12 OKR templates, 18 masterclass modules, 20 certifications, 13 guides, 200+ bibliography resources
