...
export const TECH_VENDORS: TechVendor[] = [
  ...
  },
  {
    ...
    fqhcCustomers: ["Imperial Beach Community Clinic", "Sun River Health", "AltaMed", "Sacramento Native American Health Center"],
    ehrIntegrations: [],
    hipaaCompliant: true,
    keyFeatures: [
      ...
      { en: "Sunoh.ai ambient AI scribe integrated", es: "Escriba de IA ambiental Sunoh.ai integrado" },
