...
export interface FQHCCaseStudy {
  ...
  headline: { en: string; es: string }; // 1-sentence card preview — distinct from challenge
...
export const CASE_STUDIES: FQHCCaseStudy[] = [
  ...
  // ================================================================
  {
    ...
    difficulty: "advanced",
    headline: {
      en: "A Montana FQHC cut federal dependency from 62.5% to 17% in five years by building four new revenue streams — turning a $1M deficit into positive reserves.",
      es: "Un FQHC de Montana redujo la dependencia federal del 62.5% al 17% en cinco años construyendo cuatro nuevas fuentes de ingresos — convirtiendo un déficit de $1M en reservas positivas.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "advanced",
    headline: {
      en: "MCR Health is pioneering subscription-based primary care for uninsured patients — converting uncompensated care into predictable monthly revenue through NACHC's Innovation Incubator.",
      es: "MCR Health está innovando con atención primaria basada en suscripción para pacientes sin seguro — convirtiendo atención no compensada en ingresos mensuales predecibles.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    headline: {
      en: "Highland Health grew pharmacy revenue 270% by switching from contract pharmacy to entity-owned operations, capturing 100% of 340B margins instead of splitting with chains.",
      es: "Highland Health aumentó los ingresos de farmacia un 270% al cambiar de farmacia por contrato a operaciones propias, capturando el 100% de los márgenes 340B.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "intermediate",
    headline: {
      en: "Urban Health Plan deployed AI-powered no-show prediction to achieve record-high monthly visit volumes, focusing outreach on the patients who actually needed it.",
      es: "Urban Health Plan implementó predicción de inasistencias con IA para lograr volúmenes récord de visitas mensuales, enfocando el alcance en los pacientes que realmente lo necesitaban.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    headline: {
      en: "Sun River Health's providers charted 26 patients in 30 minutes using AI ambient documentation — eliminating after-hours charting and reclaiming work-life balance.",
      es: "Los proveedores de Sun River Health documentaron 26 pacientes en 30 minutos usando documentación ambiental con IA — eliminando el trabajo después del horario.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "advanced",
    headline: {
      en: "United Health Centers launched a for-profit IPA to negotiate capitated managed care contracts directly — the most aggressive value-based payment move by a California FQHC.",
      es: "United Health Centers lanzó un IPA con fines de lucro para negociar contratos capitados directamente — la jugada de pago basado en valor más agresiva de un FQHC de California.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "intermediate",
    headline: {
      en: "Neighborhood Healthcare piloted Nabla AI for ambient clinical documentation, cutting after-hours charting by over 50% and improving provider satisfaction scores.",
      es: "Neighborhood Healthcare piloteó Nabla AI para documentación clínica ambiental, reduciendo la documentación después del horario en más del 50%.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "foundational",
    headline: {
      en: "Genesis Community Health made telehealth the primary modality for behavioral health follow-ups, expanding their service area by three counties across rural Nevada.",
      es: "Genesis Community Health hizo de la telesalud la modalidad principal para seguimiento de salud conductual, expandiendo su área de servicio por tres condados en Nevada rural.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "intermediate",
    headline: {
      en: "CommuniCare integrated dental operatories into three primary care sites, generating 15,000+ new dental encounters per year and a separate PPS dental rate.",
      es: "CommuniCare integró consultorios dentales en tres sitios de atención primaria, generando más de 15,000 nuevos encuentros dentales por año y una tarifa PPS dental separada.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "advanced",
    headline: {
      en: "Fenway Health built a nationally recognized LGBTQ+ health center serving 32,000+ patients, with specialized protocols now replicated by over 50 FQHCs nationwide.",
      es: "Fenway Health construyó un centro de salud LGBTQ+ reconocido nacionalmente sirviendo a más de 32,000 pacientes, con protocolos replicados por más de 50 FQHCs.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "advanced",
    headline: {
      en: "Callen-Lorde achieved 95% patient satisfaction through community governance — a patient-majority board and harm reduction integration serving 18,000+ LGBTQ+ New Yorkers.",
      es: "Callen-Lorde logró 95% de satisfacción del paciente a través de gobernanza comunitaria — una junta con mayoría de pacientes sirviendo a más de 18,000 neoyorquinos LGBTQ+.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "advanced",
    headline: {
      en: "Community Health Center Inc. built an embedded research institute — the Weitzman Institute — producing 200+ publications and becoming a national FQHC training center.",
      es: "Community Health Center Inc. construyó un instituto de investigación integrado — el Instituto Weitzman — produciendo más de 200 publicaciones y convirtiéndose en centro nacional de capacitación.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "advanced",
    headline: {
      en: "Yakima Valley Farm Workers Clinic grew from a single clinic to a $500M+ integrated delivery system serving 200,000+ agricultural workers across Washington and Oregon.",
      es: "Yakima Valley Farm Workers Clinic creció de una sola clínica a un sistema de entrega integrado de $500M+ sirviendo a más de 200,000 trabajadores agrícolas.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "foundational",
    headline: {
      en: "Zufall Health Center serves patients from 90+ countries in 15+ languages through radical language access and community health worker outreach — a model for immigrant healthcare.",
      es: "Zufall Health Center sirve a pacientes de más de 90 países en más de 15 idiomas a través de acceso lingüístico radical — un modelo para la atención médica de inmigrantes.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "intermediate",
    headline: {
      en: "Salud Family Health built a 4-tier CHW career ladder that cut turnover 70% and fills 80% of open positions through internal promotion — proving career pathways reduce attrition.",
      es: "Salud Family Health construyó una escalera profesional CHW de 4 niveles que redujo la rotación un 70% y llena el 80% de posiciones abiertas con promoción interna.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "intermediate",
    headline: {
      en: "Oregon's Primary Care Association built state-level collaborative QI with shared dashboards and peer learning — Oregon FQHCs now outperform national benchmarks on 7 of 9 UDS measures.",
      es: "La Asociación de Atención Primaria de Oregon construyó QI colaborativa estatal — los FQHCs de Oregon ahora superan los estándares nacionales en 7 de 9 medidas UDS.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "advanced",
    headline: {
      en: "Whitman-Walker Health reduced Ryan White funding dependency from 60%+ to under 30% of revenue by adding primary care, dental, and pharmacy — tripling their patient base.",
      es: "Whitman-Walker Health redujo la dependencia de fondos Ryan White del 60%+ a menos del 30% de ingresos agregando atención primaria, dental y farmacia — triplicando su base de pacientes.",
    },
    challenge: {
  ...
  // ================================================================
  {
    ...
    difficulty: "intermediate",
    headline: {
      en: "Asian Health Services built Oakland's leading community health model with 80%+ bilingual staff serving 50,000+ patients in 14 languages — hired from the community, for the community.",
      es: "Asian Health Services construyó el modelo de salud comunitaria líder de Oakland con más del 80% de personal bilingüe sirviendo a más de 50,000 pacientes en 14 idiomas.",
    },
    challenge: {
      en: "Oakland's Asian immigrant community — spanning Chinese, Vietnamese, Korean, Burmese, Mongolian, Tongan, and dozens more ethnic groups — faced a healthcare system that was functionally inaccessible. It wasn't just a language problem, though 15+ languages spoken in a single community is its own operational challenge. The deeper issue was trust: many patients came from countries where government institutions were instruments of control, not service. Healthcare providers who didn't share their cultural context misdiagnosed culturally specific symptoms, prescribed treatments that conflicted with traditional medicine practices, and communicated in ways that felt alienating or dismissive. For undocumented immigrants, every interaction with an official system carried deportation risk. The result: one of the largest Asian immigrant communities in the U.S. was systematically under-resourced by a healthcare system that was physically present but culturally absent.",
      es: "La comunidad inmigrante asiatica de Oakland \u2014 que abarca chinos, vietnamitas, coreanos, birmanos, mongoles, tonganos y docenas de grupos etnicos mas \u2014 enfrentaba un sistema de salud que era funcionalmente inaccesible. No era solo un problema de idioma, aunque 15+ idiomas hablados en una sola comunidad es su propio desafio operativo. El problema mas profundo era la confianza: muchos pacientes venian de paises donde las instituciones gubernamentales eran instrumentos de control, no de servicio. Los proveedores de salud que no compartian su contexto cultural diagnosticaban err\u00f3neamente sintomas culturalmente especificos, prescribian tratamientos que conflictuaban con practicas de medicina tradicional, y se comunicaban de maneras que se sentian alienantes o despectivas. Para los inmigrantes indocumentados, cada interaccion con un sistema oficial conllevaba riesgo de deportacion. El resultado: una de las comunidades inmigrantes asiaticas mas grandes de EE.UU. tenia acceso limitado a la atencion de un sistema de salud que estaba fisicamente presente pero culturalmente ausente.",
    },
    guidingPolicy: {
    ...
    outcomes: [
      ...
      },
      {
        ...
        context: {
          en: "Recognized nationally as a model for community-centered FQHC governance — demonstrating that hiring from the community and organizing with the community produces better health outcomes than parachuting services into under-resourced neighborhoods",
          es: "Reconocido a nivel nacional como modelo de gobernanza de FQHC centrada en la comunidad \u2014 demostrando que contratar de la comunidad y organizarse con la comunidad produce mejores resultados de salud que paracaidar servicios en vecindarios con recursos limitados",
        },
      },
      {
