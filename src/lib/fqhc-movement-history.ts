...
export const MOVEMENT_EVENTS: TimelineEvent[] = [
  ...
  },
  {
    ...
    primarySourceUrl: "https://laclinica.org/about/history/",
  ...
  },
  {
    ...
    primarySourceUrl: "https://cdsdp.org/patient-services/",
  ...
  },
  {
    ...
    primarySourceUrl: "https://www.altamed.org/our-history",
  ...
  },
  {
    ...
    impact: {
      en: "NEVHC grew to serve over 85,000 patients across multiple sites in the San Fernando and Santa Clarita Valleys, becoming a critical safety-net provider for one of LA's most under-resourced regions.",
      es: "NEVHC crecio para atender a mas de 85,000 pacientes en multiples sitios en los Valles de San Fernando y Santa Clarita, convirtiendose en un proveedor de red de seguridad critico para una de las regiones con menos recursos de LA.",
    },
    category: "founding",
    people: [],
  ...
  },
  {
    ...
    primarySourceUrl: "https://www.kff.org/medicaid/community-health-center-patients-financing-and-services/",
  ...
  /* ============================================================== */
  {
    ...
    primarySourceUrl: "https://www.kff.org/medicaid/issue-brief/community-health-centers-recent-growth-and-the-role-of-the-aca/",
    primarySourceOrg: "Kaiser Family Foundation",
    era: "aca-expansion",
  },
  {
  ...
  },
  {
    ...
    location: "Federal",
    primarySourceUrl: "https://www.nachc.org/policy-advocacy/policy-priorities/health-center-funding/",
...
export const CROSS_CULTURAL_ALLIANCES: CrossCulturalAlliance[] = [
  ...
  },
  {
    ...
    communities: ["Rural conservative communities", "Urban under-resourced communities"],
    period: "2001-2008",
    keyFigures: [
      {
        name: "George W. Bush",
  ...
  },
  {
    ...
    communities: ["Rural conservative communities", "Agricultural workers", "Urban under-resourced communities"],
    period: "2025-present",
    keyFigures: [],
    relevanceToFQHC: {
    ...
    primarySourceUrl: "https://www.nachc.org/policy-advocacy/",
    primarySourceOrg: "NACHC",
  },
];
