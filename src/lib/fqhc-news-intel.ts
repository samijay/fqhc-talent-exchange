...
export const INTEL_ITEMS: IntelItem[] = [
  ...
  {
    id: "hr1-lawfully-present-immigrants-federal-match-oct-2026",
    date: "2026-04-10",
    headline: {
      en: "H.R. 1 Ends Federal Medicaid Match for Asylees, Refugees, and DACA Recipients — October 1, 2026",
      es: "H.R. 1 Elimina Fondos Federales de Medicaid para Asilados, Refugiados y Receptores de DACA — 1 de Octubre de 2026",
    },
    summary: {
      en: "The House-passed reconciliation bill eliminates the federal financial participation (FFP) match for 'lawfully present' immigrants — including DACA recipients, asylees, and refugees — effective October 1, 2026. This is distinct from existing restrictions on undocumented immigrants: these populations currently receive full federal Medicaid matching funds. California FQHCs serving significant DACA and refugee populations (particularly in LA, San Diego, Central Valley) will face acute revenue loss when federal reimbursement disappears for this group — even if California chooses to continue state-only funding.",
      es: "El proyecto de reconciliación aprobado por la Cámara elimina la participación financiera federal (FFP) para inmigrantes 'presentes legalmente' — incluyendo receptores de DACA, asilados y refugiados — a partir del 1 de octubre de 2026. Esto es distinto de las restricciones existentes sobre inmigrantes indocumentados: estas poblaciones actualmente reciben fondos federales de Medicaid completos.",
    },
    category: "undocumented-access",
    impactLevel: "critical",
    type: "news",
    sourceUrl: "https://www.nachc.org/house-passes-budget-bill-what-does-this-mean-for-community-health-centers/",
    sourceOrg: "NACHC",
    region: "Federal",
    affectedOrgs: [],
    tags: ["hr1", "reconciliation", "daca", "asylees", "refugees", "lawfully-present", "federal-match", "medi-cal", "october-2026"],
    keyTakeaways: [
      { en: "Affects DACA, asylees, refugees — not just undocumented patients", es: "Afecta a DACA, asilados, refugiados — no solo pacientes indocumentados" },
      { en: "Federal match disappears October 1; CA must fund 100% state-side to maintain coverage", es: "El financiamiento federal desaparece el 1 de octubre; CA debe financiar el 100% del lado estatal para mantener cobertura" },
      { en: "Central Valley, LA, and San Diego FQHCs serving large DACA/refugee populations are highest risk", es: "Los FQHCs del Valle Central, LA y San Diego que sirven grandes poblaciones DACA/refugiados tienen el mayor riesgo" },
    ],
  },
  {
    id: "nebraska-medicaid-work-requirements-hospitals-warn-april-2026",
    date: "2026-04-13",
    headline: {
      en: "Nebraska Hospitals Warn: Medicaid Work Requirements Will Strain Staffing, Disrupt Care — A Preview for California",
      es: "Hospitales de Nebraska Advierten: Requisitos de Trabajo de Medicaid Afectarán Personal y Atención — Una Señal para California",
    },
    summary: {
      en: "Nebraska hospital systems warned April 13 that the state's imminent Medicaid work requirement implementation will strain clinical staffing and disrupt patient care continuity — the first real-world warning signal from a state moving early under the Federal Register flexibility rule. Nebraska is the first state to pursue a CMS-approved 1115 work requirement waiver in 2026. This is a direct preview of what California FQHCs will experience if CMS approves CA's projected waiver request under the June 1 IFR.",
      es: "Sistemas hospitalarios de Nebraska advirtieron el 13 de abril que la inminente implementación de los requisitos de trabajo de Medicaid del estado afectará la dotación de personal clínico y la continuidad de la atención al paciente — la primera señal de advertencia del mundo real de un estado que se mueve anticipadamente bajo la regla de flexibilidad del Registro Federal.",
    },
    category: "workforce",
    impactLevel: "high",
    type: "news",
    sourceUrl: "https://www.ktiv.com/2026/04/13/hospitals-warn-nebraska-medicaid-work-rules-could-strain-staffing-disrupt-care/",
    sourceOrg: "KTIV News 4 / Nebraska Hospital Association",
    region: "Federal",
    affectedOrgs: [],
    tags: ["work-requirements", "nebraska", "staffing", "medicaid", "early-warning", "1115-waiver", "cms"],
  },
  {
    id: "gwu-geiger-gibson-homeless-patients-medicaid-disenrollment",
    date: "2026-04-08",
    headline: {
      en: "GWU Geiger Gibson: 1.4 Million Homeless Patients at Community Health Centers Face Medicaid Disenrollment from Paperwork Barriers",
      es: "GWU Geiger Gibson: 1.4 Millones de Pacientes Sin Hogar en Centros de Salud Comunitarios Enfrentan Baja de Medicaid por Barreras Administrativas",
    },
    summary: {
      en: "A new GWU Geiger Gibson Program brief documents that 1.4 million patients experiencing homelessness currently receive care at community health centers — and these patients face disproportionate risk of Medicaid disenrollment under work requirements and documentation barriers, even when legally exempt. CHC staff will bear the burden of connecting patients to exemption documentation processes, adding administrative load at the worst possible time. California FQHCs serving high proportions of unhoused patients (particularly SF, LA, and Sacramento) should begin planning for exemption navigation workflows now.",
      es: "Un nuevo informe del Programa Geiger Gibson de GWU documenta que 1.4 millones de pacientes sin hogar reciben atención en centros de salud comunitarios y enfrentan un riesgo desproporcionado de baja de Medicaid por barreras documentales, incluso cuando están legalmente exentos.",
    },
    category: "patient-story",
    impactLevel: "high",
    type: "news",
    sourceUrl: "https://geigergibson.publichealth.gwu.edu/medicaid-cuts-will-undermine-essential-care-community-health-center-patients-experiencing",
    sourceOrg: "GWU Geiger Gibson Program in Community Health Policy",
    region: "Federal",
    affectedOrgs: [],
    tags: ["homeless", "unhoused", "medicaid", "disenrollment", "work-requirements", "documentation", "exemptions", "geiger-gibson"],
  },
  {
    id: "medi-cal-dental-cuts-49-percent-dentist-exit-2026",
    date: "2026-03-23",
    headline: {
      en: "Medi-Cal Dental Cuts Risk Driving 49% of Dentists Out of the Program — FQHC Dental Integration Under Threat",
      es: "Recortes Dentales de Medi-Cal Amenazan con Sacar al 49% de Dentistas del Programa — Integración Dental en FQHCs Bajo Amenaza",
    },
    summary: {
      en: "California Dental Association data shows that 49% of dentists currently participating in Medi-Cal say they would leave the program if proposed reimbursement cuts proceed. For FQHCs that depend on dental integration as a clinical and financial pillar — and for the 65% of FQHC patients who lack dental access nationally — this represents a potential collapse of the dental safety net. FQHCs with in-house dental departments using PPS billing have more protection, but those contracting with community dental providers face network loss.",
      es: "Datos de la Asociación Dental de California muestran que el 49% de los dentistas que participan actualmente en Medi-Cal abandonarían el programa si los recortes de reembolso propuestos proceden, poniendo en riesgo la integración dental en los FQHCs.",
    },
    category: "workforce",
    impactLevel: "high",
    type: "news",
    sourceUrl: "https://www.kvpr.org/health/2026-03-23/medi-cal-reduces-dental-care-for-undocumented-may-force-more-dentists-to-turn-away-low-income-patients",
    sourceOrg: "KVPR / California Dental Association",
    region: "California",
    affectedOrgs: [],
    tags: ["dental", "medi-cal", "dentist-exit", "reimbursement", "dental-integration", "fqhc-dental", "cda"],
  },
  {
    id: "language-service-workforce-cuts-bilingual-fresno-oc-2026",
    date: "2026-04-10",
    headline: {
      en: "KFF Health News: Fresno Loses 29 of 49 Bilingual CHW Positions; OC Cuts 27 Bilingual Mental Health Staff as Federal Cuts Hit Language Access",
      es: "KFF Health News: Fresno Pierde 29 de 49 Posiciones de CHW Bilingüe; OC Elimina 27 Puestos de Salud Mental Bilingüe al Impactar Recortes Federales el Acceso Lingüístico",
    },
    summary: {
      en: "KFF Health News documents concrete bilingual workforce losses already occurring: Fresno agencies cut from 49 to 20 CHW positions following SAMHSA funding freeze; Orange County lost 27 bilingual mental health professionals. These cuts directly threaten CLAS Standard compliance and language access obligations for FQHCs in both regions. FQHCs that relied on partner CHW agencies for community outreach are losing a critical pipeline just as Medicaid redeterminations require maximum patient navigation support.",
      es: "KFF Health News documenta pérdidas concretas de personal bilingüe: Fresno redujo de 49 a 20 posiciones de CHW tras la congelación de fondos SAMHSA; el Condado de Orange perdió 27 profesionales de salud mental bilingüe, amenazando directamente el cumplimiento de los Estándares CLAS.",
    },
    category: "workforce",
    impactLevel: "high",
    type: "news",
    sourceUrl: "https://kffhealthnews.org/news/article/language-translation-interpreters-health-services-trump-immigration-cuts-english/",
    sourceOrg: "KFF Health News",
    region: "California",
    affectedOrgs: [],
    tags: ["bilingual", "chw", "language-access", "clas-standards", "fresno", "orange-county", "samhsa", "mental-health", "workforce"],
  },
  {
    id: "chcf-riverside-county-centro-medico-fqhc-distress-2026",
    date: "2026-04-14",
    headline: {
      en: "CHCF: Riverside County Faces $11.6B Medi-Cal Disruption — Centro Medico (15K Patients) Warns of Dental, Vision, and Months-Long Wait Eliminations",
      es: "CHCF: Riverside Enfrenta Disrupción de $11.6B en Medi-Cal — Centro Medico (15K Pacientes) Advierte Eliminación de Dental, Visión y Esperas de Meses",
    },
    summary: {
      en: "A new CHCF brief documents Riverside County FQHC-level distress: Centro Medico Community Clinic (15,000 patients across 5 Inland Empire locations, nearly all Medi-Cal) warns federal cuts would force elimination of dental, vision, and podiatry services first, followed by months-long appointment delays. $11.57 billion in Medi-Cal funding flowed through Riverside County in 2024 — 34% of district residents enrolled. The African American Health Coalition (San Bernardino + Riverside) flags compounding mental health access risks.",
      es: "Un nuevo informe de CHCF documenta la angustia de FQHCs a nivel clínico en el Condado de Riverside: Centro Medico Community Clinic advierte que los recortes federales forzarían la eliminación de servicios dentales, de visión y podiatría, seguidos de esperas de meses para citas.",
    },
    category: "funding",
    impactLevel: "high",
    type: "news",
    sourceUrl: "https://www.chcf.org/blog/riverside-county-potential-medi-cal-cuts-distress-constituents-health-leaders/",
    sourceOrg: "California Health Care Foundation",
    region: "Inland Empire",
    affectedOrgs: ["Centro Medico Community Clinic"],
    affectedOrgSlugs: ["centro-medico"],
    tags: ["inland-empire", "riverside-county", "centro-medico", "medi-cal-cuts", "dental", "vision", "chcf", "funding-vulnerability"],
  },
  {
    id: "neighborhood-healthcare-rialto-sbc-expansion-may-2026",
    date: "2026-03-18",
    headline: {
      en: "Neighborhood Healthcare Opens First San Bernardino County FQHC Site in Rialto — May 2026",
      es: "Neighborhood Healthcare Abre Primera Sede FQHC del Condado de San Bernardino en Rialto — Mayo de 2026",
    },
    summary: {
      en: "Neighborhood Healthcare — which simultaneously warns of mass FQHC closures nationally — is expanding into Rialto, opening San Bernardino County's first FQHC satellite under their organization. The dual narrative (larger FQHCs absorbing territory while warning smaller ones will close) is an emerging sector dynamic: well-capitalized FQHCs with strong resilience scores are expanding capacity while simultaneously warning that the overall sector faces existential pressure. This signals a coming consolidation wave in the IE.",
      es: "Neighborhood Healthcare — que simultáneamente advierte sobre cierres masivos de FQHCs — se expande a Rialto, abriendo la primera sede satélite FQHC del Condado de San Bernardino, señalando una tendencia emergente de consolidación donde los FQHCs más grandes absorben territorio mientras los más pequeños cierran.",
    },
    category: "change-management",
    impactLevel: "medium",
    type: "news",
    sourceUrl: "https://www.nhcare.org/event/rialto-pre-opening/",
    sourceOrg: "Neighborhood Healthcare",
    region: "Inland Empire",
    affectedOrgs: ["Neighborhood Healthcare"],
    tags: ["inland-empire", "san-bernardino-county", "rialto", "expansion", "consolidation", "neighborhood-healthcare"],
  },
  {
    id: "fy2027-nimhd-elimination-minority-health-research",
    date: "2026-04-03",
    headline: {
      en: "FY2027 Budget Proposes Eliminating NIMHD as 'DEI Expenditure' — Cuts Federal Research Pipeline for FQHC Cultural Competency Models",
      es: "Presupuesto FY2027 Propone Eliminar NIMHD como 'Gasto DEI' — Recorta el Canal Federal de Investigación para Modelos de Competencia Cultural en FQHCs",
    },
    summary: {
      en: "The White House FY2027 budget proposes eliminating the National Institute on Minority Health and Health Disparities (NIMHD), characterizing it as 'replete with DEI expenditures.' The proposal also cuts CMS health equity program funding by $674M. NIMHD funds the research base for culturally concordant care models, CHW effectiveness studies, and the SDOH interventions that undergird FQHC clinical programs. While Congress is unlikely to pass the proposal verbatim, even partial cuts would sever the federal research pipeline that validates FQHC cultural humility and health equity approaches — compounding the earlier HHS OMH restructuring.",
      es: "El presupuesto FY2027 de la Casa Blanca propone eliminar el Instituto Nacional de Salud de Minorías y Disparidades de Salud (NIMHD), caracterizándolo como 'repleto de gastos DEI', y recortar los fondos de equidad de salud de CMS en $674M, amenazando la base de investigación federal que valida los modelos de competencia cultural en FQHCs.",
    },
    category: "funding",
    impactLevel: "high",
    type: "news",
    sourceUrl: "https://www.statnews.com/2026/04/03/trump-budget-health-care-12-percent-cut-hhs/",
    sourceOrg: "STAT News / White House OMB",
    region: "Federal",
    affectedOrgs: [],
    tags: ["nimhd", "fy2027-budget", "dei", "health-equity", "cultural-competency", "cms", "minority-health", "research-funding"],
  },
  {
    id: "washington-sb5981-pharma-340b-lawsuit-april-2026",
    date: "2026-04-15",
    headline: {
      en: "PhRMA Sues Washington State Over 340B Contract Pharmacy Law — Ruling Will Set National Precedent for CA AB 1460",
      es: "PhRMA Demanda al Estado de Washington por Ley de Farmacia Contratada 340B — El Fallo Establecerá Precedente Nacional para CA AB 1460",
    },
    summary: {
      en: "The pharmaceutical industry trade group PhRMA filed suit April 15 against Washington State's SB 5981, which requires drug manufacturers to reimburse 340B-covered entities when contract pharmacies are used. If courts enjoin the law before its June 10 effective date, it will freeze similar CA legislative action (AB 1460); if SB 5981 survives, AB 1460 has a significantly clearer path to passage and enforcement. This is the most directly applicable state-level 340B precedent for California FQHCs in 2026.",
      es: "PhRMA presentó demanda el 15 de abril contra la ley SB 5981 de Washington, que requiere que los fabricantes de medicamentos reembolsen a las entidades cubiertas por 340B cuando se usan farmacias contratadas. El fallo establecerá un precedente nacional crítico para el AB 1460 de California.",
    },
    category: "legislation",
    impactLevel: "high",
    type: "news",
    ...
    region: "Federal",
    affectedOrgs: [],
    tags: ["340b", "pharma", "lawsuit", "washington-state", "sb5981", "ab1460", "contract-pharmacy", "precedent"],
  },
  {
    id: "house-budget-reconciliation-framework-april-10-2026",
    type: "news",
    category: "legislation",
    impactLevel: "critical",
    date: "2026-04-10",
    headline: {
      en: "House Passes Budget Reconciliation Framework April 10 — Medicaid Cuts Now Move to Senate",
      es: "La Cámara Aprueba Marco de Reconciliación Presupuestaria el 10 de Abril — Recortes de Medicaid Pasan al Senado",
    },
    summary: {
      en: "The U.S. House passed a budget reconciliation framework on April 10, 2026 enabling the Senate to proceed with work requirements, per-capita caps, and FMAP reductions. NACHC calls it the most consequential legislative vote for health centers in a generation — and is activating in-district advocacy through April 25.",
      es: "La Cámara aprobó un marco de reconciliación el 10 de abril que permite al Senado proceder con requisitos de trabajo, límites per cápita y reducciones de FMAP. NACHC lo llama el voto más trascendente para centros de salud en una generación.",
    },
    sourceUrl: "https://www.nachc.org/house-passes-budget-bill-what-does-this-mean-for-community-health-centers/",
    sourceOrg: "NACHC",
    region: "Federal",
    affectedOrgs: [],
    tags: ["reconciliation", "medicaid", "senate", "work-requirements", "per-capita-caps", "fmap", "nachc"],
  },
  {
    ...
    date: "2026-04-14",
    headline: {
      en: "NACHC Activates National In-District Advocacy Week April 14–25 — FQHCs Hosting Congress During Recess",
      es: "NACHC Activa Semana Nacional de Cabildeo Local del 14 al 25 de Abril — FQHCs Reciben a Congresistas Durante el Receso",
    },
    summary: {
      en: "NACHC is mobilizing health centers nationally to host members of Congress in their clinics April 14–25 — the last major advocacy window before the Senate reconciliation vote on Medicaid cuts. CPCA is coordinating California in-district visits. The window is open right now.",
      es: "NACHC está movilizando centros de salud a nivel nacional para recibir a congresistas del 14 al 25 de abril — la última ventana de cabildeo importante antes del voto del Senado sobre los recortes a Medicaid.",
    },
    sourceUrl: "https://www.nachc.org/take-action-for-medicaid-reach-out-to-congress-today/",
    sourceOrg: "NACHC",
    region: "Federal",
    affectedOrgs: [],
    tags: ["advocacy", "lobbying", "congress", "medicaid", "reconciliation", "cpca", "in-district"],
  },
  {
    id: "altamed-medi-cal-redetermination-navigation-2026",
    type: "news",
    category: "undocumented-access",
    impactLevel: "medium",
    date: "2026-01-01",
    headline: {
      en: "AltaMed Launches Medi-Cal Redetermination Navigation Hub — Asset Test and UIS Freeze Creating Enrollment Churn",
      es: "AltaMed Lanza Centro de Navegación para Redeterminación de Medi-Cal — Prueba de Activos y Congelamiento UIS Crean Rotación de Inscripción",
    },
    summary: {
      en: "AltaMed is operating a dedicated Medi-Cal redetermination hotline and FAQ hub as California's new $130K asset test and undocumented enrollment freeze create significant navigation burden. FQHCs are becoming de facto Medi-Cal eligibility navigators — an uncompensated administrative cost landing on top of revenue cuts.",
      es: "AltaMed opera una línea de apoyo dedicada para la redeterminación de Medi-Cal mientras la nueva prueba de activos y el congelamiento de inscripción crean una carga administrativa significativa para los FQHCs.",
    },
    sourceUrl: "https://www.altamed.org/2026-medi-cal-redetermination-faqs",
    sourceOrg: "AltaMed Health Services",
    affectedOrgSlugs: ["altamed-health-services"],
    region: "Los Angeles",
    affectedOrgs: ["AltaMed Health Services"],
    tags: ["medi-cal", "redetermination", "asset-test", "undocumented", "enrollment", "altamed", "navigation"],
  },
  {
    id: "sfchc-transthrive-clinic-opening-april-2026",
    type: "news",
    category: "change-management",
    impactLevel: "medium",
    date: "2026-04-01",
    headline: {
      en: "SF Community Health Center Opens Dedicated TransThrive Drop-In Clinic — Model for Gender-Affirming FQHC Care",
      es: "SF Community Health Center Abre Clínica Dedicada TransThrive — Modelo de Atención Afirmadora de Género en FQHCs",
    },
    summary: {
      en: "San Francisco Community Health Center opened a dedicated TransThrive drop-in nursing and sexual health clinic in April 2026, offering gender-affirming care, HIV prevention/treatment, and complex care coordination — a rare FQHC expansion amid federal cuts and growing attacks on trans healthcare. The clinic opens months after SFCHC's TransHOPE funding was terminated.",
      es: "SF Community Health Center abrió en abril de 2026 una clínica dedicada TransThrive de enfermería y salud sexual, ofreciendo atención afirmadora de género y servicios de VIH — una expansión rara en medio de recortes federales.",
    },
    sourceUrl: "https://www.sfcommunityhealth.org/newsroom/april2026",
    sourceOrg: "San Francisco Community Health Center",
    affectedOrgSlugs: ["san-francisco-community-health-center"],
    region: "Bay Area",
    affectedOrgs: ["San Francisco Community Health Center"],
    tags: ["trans-health", "gender-affirming", "hiv", "expansion", "san-francisco", "positive"],
  },
  {
    id: "hospital-merger-rebound-q1-2026-fqhc-consolidation-risk",
    type: "news",
    category: "merger-acquisition",
    impactLevel: "medium",
    date: "2026-04-01",
    headline: {
      en: "Hospital Merger Activity Rebounds in Q1 2026 — Distress-Driven Deals Signal FQHC Consolidation Wave Ahead",
      es: "Fusiones Hospitalarias Repuntan en Q1 2026 — Operaciones por Angustia Financiera Señalan Ola de Consolidación de FQHCs",
    },
    summary: {
      en: "Hospital merger activity rebounded in Q1 2026 with distress-driven deals accelerating — a trend that historically precedes FQHC consolidation waves. As hospitals close or merge, FQHCs lose established referral partners and face acquisition interest from larger health systems. California's H.R. 1 financial pressure is making previously independent FQHCs vulnerable.",
      es: "La actividad de fusiones hospitalarias repuntó en Q1 2026, una tendencia que históricamente precede oleadas de consolidación en FQHCs a medida que organizaciones de la red de seguridad pierden socios de referencia.",
    },
    sourceUrl: "https://www.chiefhealthcareexecutive.com/view/hospital-merger-activity-rebounds-in-first-quarter",
    sourceOrg: "Chief Healthcare Executive",
    region: "National",
    affectedOrgs: [],
