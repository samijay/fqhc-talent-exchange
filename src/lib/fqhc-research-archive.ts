...
export const CURRICULUM_TRACKS: CurriculumTrack[] = [
  {
    ...
    levels: [
      ...
      { level: "intermediate", label: { en: "Clinical Evidence & Integration", es: "Evidencia Clínica e Integración" }, entryIds: ["starfield-primary-care-specialty-2005", "unuetzer-collaborative-care-2002", "jackson-pcmh-systematic-review-2013", "shi-fqhc-diabetes-outcomes-2012", "dhcs-calaims-ecm-2022"] },
      { level: "advanced", label: { en: "Innovation & Emerging Practice", es: "Innovación y Práctica Emergente" }, entryIds: ["lin-ambient-ai-documentation-2024", "abridge-best-in-klas-2026", "samhsa-ccbhc-certification-2024", "uscher-pines-telehealth-fqhcs-2022"] },
    ],
  },
  {
    ...
    levels: [
      ...
      { level: "intermediate", label: { en: "Building Your Practice", es: "Construyendo Tu Práctica" }, entryIds: ["kim-chw-systematic-review-2016", "kangovi-impress-trial-2020", "nachc-chw-integration-guide-2023", "ca-sb803-chw-certification-2021", "dhcs-calaims-ecm-2022"] },
      { level: "advanced", label: { en: "Research & Advocacy", es: "Investigación y Abogacía" }, entryIds: ["pinto-structural-racism-fqhcs-2022", "ortega-undocumented-health-access-2015", "villarejo-farmworker-health-2016"] },
    ],
  },
  {
  ...
  },
  {
    ...
    levels: [
      { level: "foundational", label: { en: "FQHC Business Model", es: "Modelo de Negocio de FQHCs" }, entryIds: ["taylor-section-330-history-2004", "rosenbaum-pps-fqhc-reimbursement-2010", "340b-hrsa-program-overview-2024", "nachc-workforce-study-2023", "ca-sb525-healthcare-minimum-wage-2023"] },
      { level: "intermediate", label: { en: "Revenue & Sustainability", es: "Ingresos y Sostenibilidad" }, entryIds: ["shin-fqhc-medicaid-dependence-2020", "rosenbaum-fqhc-policy-evolution-2017", "ncqa-pcmh-standards-2023", "hrsa-uds-reporting-2024", "vujicic-dental-safety-net-2021"] },
      { level: "advanced", label: { en: "Innovation & Transformation", es: "Innovación y Transformación" }, entryIds: ["mcwilliams-aco-savings-2016", "lin-ambient-ai-documentation-2024", "samhsa-ccbhc-certification-2024", "abridge-best-in-klas-2026"] },
    ],
  },
]
