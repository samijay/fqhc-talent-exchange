...
export const CAREER_PAGE_CONFIGS: CareerPageConfig[] = [
  // ── Scrapeable via JSON API ── ✅
  {
    ...
    notes:
      "Largest FQHC in CA. 266 jobs found 2026-04-11 (prev 255, +11 — hiring surge). AltaMed generated $15.1B economic impact (2019-2024), supports 12,000 jobs, serves 465,000 Medi-Cal patients. Abridge AI scribe deployment confirmed. Workday JSON API works. POST with {appliedFacets:{},limit:20,offset:0,searchText:''}.",
  },
  {
  ...
  },
  {
    ...
    notes:
      "20 jobs found 2026-04-11 (prev 20, stable). Lever slug is 'ahschc'.",
  },
  {
    ...
    notes:
      "166 jobs found 2026-04-11 (prev 173, -7 — notable decline). Uses HRMDirect — server-rendered HTML, scrapeable via WebFetch. No JSON API but standard HTML parsing works.",
  },
