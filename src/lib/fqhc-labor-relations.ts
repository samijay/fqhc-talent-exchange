...
export const LABOR_CASES: LaborCase[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { date: "2026-03-17", description: { en: "AHS Board of Trustees votes to defer all layoffs through June 30, 2026 (fiscal year end); SEIU 1021 oversight committee continues", es: "La Junta Directiva de AHS vota aplazar todos los despidos hasta el 30 de junio de 2026 (fin del año fiscal); el comité de supervisión del SEIU 1021 continúa" }, sourceUrl: "https://www.seiu1021.org/ahs" },
    ],
    nextMilestone: { date: "2026-06-30", description: { en: "Layoff deferral expires June 30 — if $91.7M working group finds no resolution, 188-300 layoffs proceed July 2026; SEIU 1021 has 99.5% strike authorization on record", es: "El aplazamiento de despidos expira el 30 de junio — si el grupo de trabajo de $91.7M no encuentra solución, 188-300 despidos proceden en julio de 2026; SEIU 1021 tiene autorización de huelga del 99.5%" } },
...

  {
    ...
    title: {
      en: "Community Medical Centers (Stockton) — NLRB Bad-Faith Bargaining Complaint (CLOSED)",
      es: "Community Medical Centers (Stockton) — Queja de Negociación de Mala Fe ante NLRB (CERRADO)",
    },
    summary: {
      en: "NLRB Case 32-CA-377500 filed December 17, 2025 by SEIU Local 1021 — alleged 8(a)(5) bad-faith bargaining and 8(a)(3) retaliation against Community Medical Centers in Stockton. Case CLOSED April 7, 2026: NLRB General Counsel approved SEIU 1021's withdrawal request. Likely indicates a negotiated resolution; no public settlement announced. First FQHC bad-faith bargaining complaint in the Central Valley, resolved within 4 months of filing.",
      es: "Caso NLRB 32-CA-377500 presentado el 17 de diciembre de 2025 por SEIU Local 1021. Caso CERRADO el 7 de abril de 2026: NLRB aprobó la solicitud de retiro de SEIU 1021. Probablemente indica una resolución negociada; no se anunció acuerdo público.",
    },
    caseType: "nlrb-complaint",
    status: "resolved",
    posture: "neutral",
    ...
    timeline: [
      ...
      { date: "2026-04-07", description: { en: "Case closed — NLRB General Counsel approved SEIU 1021 withdrawal request; likely negotiated resolution", es: "Caso cerrado — NLRB aprobó solicitud de retiro de SEIU 1021; probablemente resolución negociada" }, sourceUrl: "https://www.nlrb.gov/case/32-CA-377500" },
    ],
    nextMilestone: { date: "2026-04-07", description: { en: "Case closed April 7, 2026 — no further milestones", es: "Caso cerrado el 7 de abril de 2026 — no hay más hitos" } },
