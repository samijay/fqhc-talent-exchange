...
const content = {
  en: {
    ...
    yesPostOnSite: "Yes, post on FQHC Talent",
    ...
    successStep3: "Market Intelligence",
    successStep3Desc: "Explore salary benchmarks, workforce data, and strategic insights for FQHC hiring.",
    whileYoureHere: "While You're Here",
    browseCandidates: "Post on FQHC Talent",
  ...
  es: {
    ...
    yesPostOnSite: "Sí, publicar en FQHC Talent",
    ...
    browseCandidates: "Publicar en FQHC Talent",
