...
export default function HirePage() {
  ...
  function validate(): boolean {
    ...
    if (!orgName.trim()) next.orgName = "Organization name is required.";
        ...
        <div className="mx-auto max-w-2xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
          <div className="rounded-2xl border border-stone-200 bg-white p-8 text-center shadow sm:p-12">
            ...
            <p className="mx-auto mt-4 max-w-md text-stone-600">
              We&apos;ll be in touch within 48 hours. FQHCs are onboarded in
              the order we receive requests.
            </p>
      ...
      <section className="bg-gradient-to-br from-teal-600 via-teal-700 to-teal-800 py-14 text-center text-white sm:py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-xl text-base text-teal-100/80 sm:text-lg">
            We work with a limited number of FQHCs at a time to ensure every
            placement gets our full attention. Tell us about your hiring needs.
          </p>
          ...
          {waitlistCount !== null && waitlistCount > 0 && (
            <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-teal-400/30 bg-teal-500/20 px-4 py-2 text-sm font-medium text-teal-100">
              ...
              {waitlistCount} FQHC{waitlistCount === 1 ? " has" : "s have"}{" "}
              requested access
            </div>
          )}
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="rounded-2xl bg-white p-6 shadow sm:p-8">
            <div className="space-y-8">
              ...
              {/* ====== Positions count ====== */}
              <div className="space-y-1.5">
                <Label>Number of Positions to Fill</Label>
                <Select
              ...
              <div className="space-y-1.5">
                ...
                <Textarea
                  id="notes"
                  placeholder="Tell us about specific requirements, unique challenges, or anything that would help us prepare..."
                  rows={4}
                  value={notes}
