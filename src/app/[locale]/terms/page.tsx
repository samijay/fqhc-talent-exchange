  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Progress saving and data sync: Some tools offer the option to save your progress by providing your email address. When you choose to save your progress, your tool data (such as course completion, assessment results, or OKR templates you've customized) is stored on our servers so you can access it from any device. This is entirely optional — all tools work without saving, and your local progress in your browser is never deleted when you choose to sync. See our Privacy Policy for details on how we store and protect this data.",
        "Usage analytics: We collect anonymous usage data about how our tools are used (for example, which templates are downloaded most often, or which simulator scenarios are most popular). This helps us prioritize improvements and build better tools. Our Privacy Policy explains exactly what we collect and how it's used.",
      ],
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Guardado de progreso y sincronización de datos: Algunas herramientas ofrecen la opción de guardar su progreso proporcionando su dirección de correo electrónico. Cuando elige guardar su progreso, los datos de su herramienta (como la finalización de cursos, resultados de evaluaciones o plantillas OKR que haya personalizado) se almacenan en nuestros servidores para que pueda acceder a ellos desde cualquier dispositivo. Esto es completamente opcional — todas las herramientas funcionan sin guardar, y su progreso local en su navegador nunca se elimina cuando elige sincronizar. Consulte nuestra Política de Privacidad para más detalles sobre cómo almacenamos y protegemos estos datos.",
        "Análisis de uso: Recopilamos datos anónimos de uso sobre cómo se utilizan nuestras herramientas (por ejemplo, qué plantillas se descargan con más frecuencia o qué escenarios de simulador son más populares). Esto nos ayuda a priorizar mejoras y construir mejores herramientas. Nuestra Política de Privacidad explica exactamente qué recopilamos y cómo se utiliza.",
      ],
    },
    {
