...
const enContent: TermsContent = {
  ...
  sections: [
    ...
    {
      heading: "11. Data Use and Privacy",
      paragraphs: [
    ...
    {
      heading: "16. No Employment Relationship",
      paragraphs: [
    ...
    {
      heading: "17. Third-Party Content and Links",
      paragraphs: [
    ...
    {
      heading: "21. Entire Agreement and Severability",
      paragraphs: [
...
const esContent: TermsContent = {
  ...
  sections: [
    ...
    {
      heading: "11. Uso de Datos y Privacidad",
      paragraphs: [
    ...
    {
      heading: "12. Renuncia de Garantías",
      paragraphs: [
    ...
    {
      heading: "16. Sin Relación Laboral",
      paragraphs: [
    ...
    {
      heading: "17. Contenido y Enlaces de Terceros",
      paragraphs: [
    ...
    {
      heading: "21. Acuerdo Completo y Divisibilidad",
      paragraphs: [
