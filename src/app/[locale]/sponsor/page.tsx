        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { icon: BarChart3, label: "Intel Items Tracked", value: "150+", sub: "Primary sources for every claim" },
              { icon: Target, label: "FQHC Jobs Monitored", value: "1,586", sub: "Across 30+ organizations" },
