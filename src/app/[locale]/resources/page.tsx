...
const blogPosts = [
  {
    ...
    description: "Free career tools and priority intake for displaced community health workers — resume builder, assessment, and job matching.",
    esDescription: "Herramientas gratis de carrera y admisión prioritaria para trabajadores de salud comunitaria desplazados — CV, evaluación y búsqueda de empleo.",
    category: "Fast-Track",
