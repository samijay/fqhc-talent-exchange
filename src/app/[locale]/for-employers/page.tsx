...
const content = {
  en: {
    ...
    sourcingTitle: "Workforce Intelligence",
    sourcingBody: "Access our strategic insights, salary benchmarks, and workforce data across 220+ California FQHCs.",
    introsTitle: "Resources Delivered",
    introsBody: "We share relevant workforce intelligence, market data, and career tools to support your hiring.",
  },
  es: {
    ...
    sourcingBody: "Utilizamos nuestro grupo de talento FQHC pre-evaluado y comenzamos a buscar coincidencias para sus roles abiertos.",
