  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-teal-50 border border-teal-200 rounded-xl p-8 text-center">
            ...
            <p className="text-stone-600 mb-6 text-lg">
              ...
              Browse job openings at Sacramento-area community health centers —
      ...
      <section className="py-8 px-6">
        <div className="max-w-4xl mx-auto">
          <Link
            href={"/intelligence/sacramento" as "/jobs"}
          ...
          >
            <div>
              <p className="text-sm font-semibold text-teal-800">Sacramento Regional Intelligence</p>
