...
export default function Home() {
  ...
  const jobOrgs = new Set(fqhcJobListings.map((j) => j.fqhcSlug)).size;
    ...
    mainEntity: {
      ...
      dataset: [
        ...
        },
        {
          ...
          description: `${homepageData.totalJobs}+ open positions across 30+ roles at ${jobOrgs} California FQHCs`,
          url: `${SITE_URL}/jobs`,
        },
        {
          "@type": "Dataset",
