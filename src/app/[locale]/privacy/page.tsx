  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "Progreso de aprendizaje y cursos: Cuando utiliza nuestros cursos de la Academia (como el Curso OKR), rutas de aprendizaje o simuladores interactivos, su progreso, módulos completados y XP ganados se almacenan localmente en su navegador (localStorage). Si elige guardar su progreso (proporcionando su correo electrónico), sincronizamos estos datos con nuestros servidores para que pueda continuar donde lo dejó en cualquier dispositivo. Nunca es obligatorio sincronizar — el progreso solo local funciona perfectamente.",
        "Datos de uso de herramientas: Cuando utiliza nuestras herramientas interactivas (simuladores, plantillas OKR, creador de currículum, evaluación de carrera, rutas de aprendizaje), recopilamos eventos de uso anónimos — como qué herramienta utilizó, qué plantilla descargó o qué escenario de simulador ejecutó. Esto nos ayuda a entender qué herramientas son más valiosas para seguir mejorándolas. Si proporciona su correo electrónico (por ejemplo, para guardar su progreso o descargar resultados), asociamos ese evento con su correo electrónico. Nunca rastreamos el uso de herramientas sin su interacción activa — rastreamos las acciones que usted realiza, no las páginas que visita.",
        ...
        "Progreso de lectura de contenido: Si ha iniciado sesión, rastreamos automáticamente qué contenido ve (guías, masterclasses, artículos de investigación, publicaciones de blog) y cuánto ha avanzado. Esto alimenta su panel personalizado y la pestaña de Biblioteca, mostrándole lo que ha leído y lo que todavía está leyendo. Este seguimiento solo ocurre para usuarios autenticados — los visitantes anónimos no son rastreados. Puede ver y administrar su historial de lectura en su panel.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Academia y herramientas de aprendizaje: Para proporcionar cursos interactivos, simuladores y contenido educativo a través de nuestra Academia FQHC. El progreso del curso se rastrea localmente en su navegador por defecto. Si elige guardar su progreso con su correo electrónico, lo almacenamos en el servidor para que pueda continuar en cualquier dispositivo. Los resultados de evaluaciones de herramientas como Perspectivas de Carrera y Preparación de Equipo pueden almacenarse para proporcionar recomendaciones personalizadas.",
        "Mejora de herramientas: Para entender qué herramientas, plantillas y funciones son más utilizadas y más valiosas. Analizamos patrones anónimos de uso de herramientas (como: qué plantillas OKR se descargan más, qué escenarios de simulador se ejecutan con más frecuencia) para priorizar mejoras. Estos datos son agregados — nos importan las tendencias, no el comportamiento individual.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Datos de evaluación y cursos: Los resultados de evaluaciones de carrera, evaluaciones de preparación de equipo y otros datos generados por herramientas se retienen mientras su perfil exista. El progreso de cursos almacenado localmente (en su navegador) persiste hasta que borre los datos de su navegador. El progreso de cursos sincronizado con el servidor (si optó por hacerlo proporcionando su correo electrónico) se retiene hasta que solicite su eliminación.",
        "Eventos de uso de herramientas: Los datos anónimos de uso de herramientas (qué herramientas y plantillas utilizó) se retienen por hasta 24 meses para análisis de mejora del producto. Si proporcionó su correo electrónico con un evento de herramienta, puede solicitar la eliminación en cualquier momento.",
