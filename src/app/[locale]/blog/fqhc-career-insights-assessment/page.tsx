...
export default async function FqhcCareerInsightsAssessmentArticle() {
  ...
  return (
    <main className="min-h-screen">
      ...
      />
      <ContentViewTracker contentType="blog" contentId="fqhc-career-insights-assessment" />
      <BlogArticleToolbar slug="fqhc-career-insights-assessment" />
      ...
      <article className="py-16 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <BlogPrevNext slug="fqhc-career-insights-assessment" locale={locale} />
