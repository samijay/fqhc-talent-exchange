      ...
      <article className="py-16 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg prose-stone max-w-none">
            ...
            <p className="text-stone-700 leading-relaxed">
              Leading FQHCs are allocating 30&ndash;45 minute visits for patients with multiple chronic conditions, complex medication regimens, recent hospitalizations, behavioral health integration needs, or social determinants of health crises. These are the encounters that require a physician&apos;s or NP&apos;s clinical judgment, prescribing authority, and decision-making ability. These are also the encounters that, when done well, prevent ED visits, hospitalizations, and emergency care.
            </p>
            <p className="text-stone-700 leading-relaxed">
            ...
            <p className="text-stone-700 leading-relaxed">
              <strong>The Structure:</strong> A primary care team consists of one physician or NP, two to three RNs, and three to five MAs. Each RN manages a panel of 600&ndash;800 patients, handling preventive care, stable chronic disease management, and care coordination. Each MA supports two providers or one RN and one provider, depending on staffing.
            </p>
            <p className="text-stone-700 leading-relaxed">
            ...
            <div className="bg-stone-50 rounded-lg p-6 my-6">
              ...
              <ul className="text-stone-700 space-y-3">
                <li>
                  &ldquo;<strong>Conducted comprehensive annual wellness visits</strong> for stable patients, including medication reconciliation, preventive care gap identification, and provider co-sign documentation.&rdquo;
                </li>
                <li>
                  &ldquo;<strong>Performed expanded rooming</strong> including full medication reconciliation, HCC coding preparation, care gap identification, and social determinants of health screening to reduce provider time and improve care quality.&rdquo;
                </li>
                <li>
                  &ldquo;<strong>Managed a panel of 700 patients</strong> as the primary RN care coordinator, handling preventive care visits, new patient intakes, and transitions of care while escalating complex cases to the provider.&rdquo;
                </li>
                <li>
                  &ldquo;<strong>Worked within team-based care model</strong> where physicians focused on complex patients and acute care while RNs managed preventive care and stable chronic disease management.&rdquo;
                </li>
                <li>
                  &ldquo;<strong>Initiated workflow improvements</strong> to maximize provider time for complexity by implementing expanded MA rooming protocols and nurse-conducted wellness visits.&rdquo;
                </li>
              </ul>
            </div>
            <p className="text-stone-700 leading-relaxed">
            ...
            <ul className="text-stone-700 leading-relaxed space-y-2">
              <li>
                &ldquo;How do you structure your clinical teams? What is the typical RN-to-provider ratio and MA-to-provider ratio?&rdquo;
              </li>
              <li>
                &ldquo;Do your RNs conduct annual wellness visits or new patient intakes? How are those documented and reviewed?&rdquo;
              </li>
              <li>
                &ldquo;What does an expanded MA role look like here? What are you looking for MAs to do beyond vital signs?&rdquo;
              </li>
              <li>
                &ldquo;How are visit types assigned? Who decides whether a patient should see a provider versus an RN?&rdquo;
              </li>
              <li>
                &ldquo;What's the provider schedule like? How much time is allocated for different types of visits?&rdquo;
              </li>
              <li>
                &ldquo;How do you support staff in working at the top of their scope? What training or mentorship is available?&rdquo;
              </li>
            </ul>
            <p className="text-stone-700 leading-relaxed">
