...
const posts = [
  ...
  },
  {
    ...
    title: "Laid Off from an FQHC? Here\u2019s How to Get Rehired in 48 Hours",
    esTitle: "¿Despedido/a de un FQHC? Cómo Conseguir Recontratación en 48 Horas",
    description: "Thousands of community health workers in California are being displaced by Medi-Cal funding cuts and FQHC restructuring. But many FQHCs are still hiring. Learn how the Fast-Track program can connect you to your next role in 48 hours.",
    esDescription: "Miles de trabajadores de salud comunitaria en California están siendo desplazados por recortes de fondos de Medi-Cal y reestructuración de FQHCs. Pero muchos FQHCs siguen contratando. Aprende cómo el programa Fast-Track puede conectarte con tu próximo puesto en 48 horas.",
    date: "February 15, 2026",
    esDate: "15 de febrero de 2026",
    category: "Career Resources",
    esCategory: "Recursos Profesionales",
