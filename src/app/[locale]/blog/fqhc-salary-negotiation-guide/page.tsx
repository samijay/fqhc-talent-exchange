        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-12 pt-8 border-t border-stone-200 dark:border-stone-700">
            ...
            <ol className="list-decimal list-inside space-y-2 text-sm text-stone-600 dark:text-stone-500">
              <li><a href="https://nhsc.hrsa.gov/loan-repayment/nhsc-loan-repayment-program" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-700 underline">NHSC Loan Repayment Program</a> &mdash; HRSA, 2026. {locale === "es" ? "Hasta $75,000 (tiempo completo) o $50,000 (otros proveedores) libres de impuestos en pagos de pr\u00e9stamos estudiantiles por 2 a\u00f1os de servicio." : "Up to $75,000 (full-time primary care) or $50,000 (other providers) in tax-free student loan payments for a 2-year service commitment."}</li>
              <li><a href="https://www.cms.gov/medicare/payment/prospective-payment-systems/fqhc_pps" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-700 underline">FQHC Prospective Payment System (PPS)</a> &mdash; CMS. {locale === "es" ? "Tasa base PPS 2025 de $202.65 por visita, con ajuste geogr\u00e1fico." : "2025 PPS base rate of $202.65 per visit, with geographic adjustment."}</li>
              <li><a href="https://www.macpac.gov/wp-content/uploads/2017/12/Medicaid-Payment-Policy-for-Federally-Qualified-Health-Centers.pdf" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-700 underline">Medicaid Payment Policy for Federally Qualified Health Centers</a> &mdash; MACPAC. {locale === "es" ? "Pol\u00edtica de pago de Medicaid PPS y metodolog\u00edas de pago alternativas para FQHCs." : "Medicaid PPS payment policy and alternative payment methodologies for FQHCs."}</li>
              <li><a href="https://data.hrsa.gov/topics/health-centers/uds" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-700 underline">Health Center Program Uniform Data System (UDS) Data</a> &mdash; HRSA, 2024. {locale === "es" ? "Datos de dotaci\u00f3n de personal, volumen de pacientes e ingresos de centros de salud." : "Health center staffing, patient volume, and revenue data."}</li>
              <li><a href="https://bphc.hrsa.gov/compliance/compliance-manual/introduction" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-700 underline">{locale === "es" ? "Introducci\u00f3n al Manual de Cumplimiento del Programa de Centros de Salud" : "Health Center Program Compliance Manual Introduction"}</a> &mdash; HRSA BPHC. {locale === "es" ? "Subvenciones Secci\u00f3n 330, elegibilidad y requisitos del programa." : "Section 330 grants, eligibility, and program requirements."}</li>
              <li><a href="https://www.bls.gov/ooh/community-and-social-service/community-health-workers.htm" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-700 underline">Community Health Workers: Occupational Outlook Handbook</a> &mdash; U.S. Bureau of Labor Statistics, 2024. {locale === "es" ? "Salario medio anual de $48,200 para CHW a nivel nacional." : "Median annual salary of $48,200 for CHWs nationally."}</li>
              <li><a href="https://www.bls.gov/ooh/healthcare/" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-700 underline">Healthcare Occupations: Occupational Outlook Handbook</a> &mdash; U.S. Bureau of Labor Statistics, 2024. {locale === "es" ? "Datos salariales y perspectivas para enfermeros, dentistas, m\u00e9dicos y otros roles cl\u00ednicos." : "Salary data and outlook for nurses, dentists, physicians, and other clinical roles."}</li>
              <li><a href="https://www.dol.gov/agencies/ebsa/laws-and-regulations/laws/cobra" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-700 underline">COBRA Continuation Coverage</a> &mdash; U.S. Department of Labor. {locale === "es" ? "Ley federal COBRA para continuaci\u00f3n de cobertura de salud grupal." : "Federal COBRA law for group health coverage continuation."}</li>
              <li><a href="https://www.nachc.org/membership/nachc-salary-benefits-report/" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-700 underline">NACHC Salary &amp; Benefits Report</a> &mdash; NACHC. {locale === "es" ? "Datos de compensaci\u00f3n de centros de salud incluyendo salarios, beneficios y planes de jubilaci\u00f3n." : "Health center compensation data including salaries, benefits, and retirement plans."}</li>
              <li><a href="https://www.dhcs.ca.gov/services/Pages/FQHC_APM.aspx" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-700 underline">{locale === "es" ? "Metodolog\u00eda de Pago Alternativa para FQHCs" : "FQHC Alternative Payment Methodology Pilot"}</a> &mdash; California DHCS. {locale === "es" ? "Piloto de pago capitado de Medi-Cal para FQHCs participantes." : "Medi-Cal capitated payment pilot for participating FQHCs."}</li>
            </ol>
          </div>
