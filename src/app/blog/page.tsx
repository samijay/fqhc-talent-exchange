      ...
      <section className="bg-gradient-to-br from-teal-50 via-teal-50 to-stone-50 py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-stone-900 mb-6">
            FQHC Career Resources &amp; Insights
          </h1>
          <p className="text-xl text-stone-600 max-w-2xl mx-auto leading-relaxed">
            Expert guides on community health careers, Medi-Cal program updates,
            salary data, and hiring trends for Federally Qualified Health
            Centers.
          </p>
        </div>
      </section>
